...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'game/images/bird.png'
BACKGROUND = 'game/images/background2.png'
PIPE = 'game/images/pipe.png'
...
def mainGame():
    ...
    playerFlapped = False #it is true only while flapping
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird By Rugved')
    GAME_SPRITES['numbers'] = (
        ...
        pygame.image.load('game/images/10.png').convert_alpha(),
    )
    GAME_SPRITES['message'] = pygame.image.load('game/images/message.png').convert_alpha()
    GAME_SPRITES['base'] = pygame.image.load('game/images/base.png').convert_alpha()
    ...
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('game/sounds/swoosh.wav')
    ...
    while True:
        welcomeScreen() # shows welcome screen until clicks the button
